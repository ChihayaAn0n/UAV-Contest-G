...
def get_parser():
    ...
    parser.add_argument('-model_saved_name', default='./output/tegcn_V1_J_3d')
    parser.add_argument(
        '--config',
        default='./config/tegcn_V1_J_3d.yaml',
...
class Processor():
    ...
    def load_data(self):
        ...
        # print("Train feeder args:", self.arg.train_feeder_args)
        # print("Loaded dataset samples:", dataset)
        # print(dataset)
        # print("Data path:", self.data_path)
        # print("Label path:", self.label_path)
        #
        # print("Data shape:", self.data.shape if self.data is not None else "Data not loaded")
        # print("Labels length:", len(self.label) if self.label is not None else "Labels not loaded")
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            # self.data_loader[ln].dataset.sample_name = ['test_' + str(i) for i in range(len(self.data))]
            score_dict = dict(
                zip(['test_' + str(i) for i in range(4307)], score))
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            rf = self.arg.model_saved_name + '_.txt'
